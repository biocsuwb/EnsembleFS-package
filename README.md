...
The clinical data (18 features, 1394 samples) of breast cancer patients from Molecular Taxonomy of Breast Cancer International Consortium (METABRIC) project ([Pereira et. al 2016](https://www.jstatsoft.org/article/view/v085i12](https://www.nature.com/articles/ncomms11479))). The "class" column includes the clinical endpoints of patients. This data is available at ([exampleData_METABRIC_clinical.csv](https://github.com/biocsuwb/EnsembleFS-package/tree/main/data)). 
...
```r
library (readr)
urlfile="https://github.com/biocsuwb/EnsembleFS-package/blob/main/data/exampleData_TCGA_LUAD_2000.csv"
...
## Example 4 - ensemble feature selection of clinical data
